...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Link.seconds'
        db.add_column(u'mezzit_link', 'seconds',
                      self.gf('django.db.models.fields.FloatField')(default=1363036299.867722),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Link.seconds'
        db.delete_column(u'mezzit_link', 'seconds')
    ...
    models = {
        ...
        u'mezzit.link': {
            ...
            'seconds': ('django.db.models.fields.FloatField', [], {'default': '1363036299.927578'}),
