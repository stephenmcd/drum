...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Link.score'
        db.delete_column(u'mezzit_link', 'score')


    def backwards(self, orm):
        # Adding field 'Link.score'
        db.add_column(u'mezzit_link', 'score',
    ...
    models = {
        ...
        u'mezzit.link': {
            ...
            'rating_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'rating_sum': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'seconds': ('django.db.models.fields.FloatField', [], {'default': '1363122360.727561'}),
