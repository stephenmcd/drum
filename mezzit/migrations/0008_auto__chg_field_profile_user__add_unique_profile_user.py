...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mezzit_profile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Profile', fields ['user']
        db.create_unique('mezzit_profile', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Profile', fields ['user']
        db.delete_unique('mezzit_profile', ['user_id'])


        # Changing field 'Profile.user'
        db.alter_column('mezzit_profile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
